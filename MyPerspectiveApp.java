...
public class MyPerspectiveApp extends JFrame implements KeyListener {
   ...
   public void paint(Graphics g) {
	...
	private void PerspectiveProjection_RotateCube_X_Axis() {
		//X rotate
	...
	private void PerspectiveProjection_RotateCube_Y_Axis() {
		//Y rotate
		double angle_in_radians = Math.toRadians(15);
	...
	private void PerspectiveProjection_RotateCube_Z_Axis() {
		//Z rotate
		double angle_in_radians = Math.toRadians(15);
